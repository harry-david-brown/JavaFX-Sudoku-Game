...
public class Game {
	...
	/**
	 * Uncovered Game board
	 */
	private ArrayList<Integer> board;

	/**
	 * Semi-uncovered Game board
	 */
	...
	/**
	 * Getter method for the player's game
	 * 
	 * @return an ArrayList containing the player's Game board
	 */
	...
	/**
	 * Generates the player's board using specified num
	 * 
	 * @param num
	 */
	...
	/**
	 * Recursive method generateBoard
	 * 
	...
	/**
	 * Returns an ArrayList containing every number in the  block
	 * 
	 * @param num the block number
	 * @param list an ArrayList containing the Game board
	...
	/**
	 * Checks if the block if full and valid 
	 * 
	 * @param num  the block number
	 * @param list an ArrayList containing the Game board
	...
	/**
	 * Checks if the board conforms to the Game rules
	 * 
	 * @param list an ArrayList representing the Game board
	 ...
	 * ArrayList
	 * 
	 * @param num   an ArrayList representing the Game board
	 ...
	 * @param list an ArrayList of the Game board
	...
	/**
	 * Creates a Game board with the provided ArrayList
	 * 
	 * @param num ArrayList representing a Game board
	...
	/**
	 * Builds a String representation of the Game board
	 *
	 * @return String representation of the Game board
	 */
